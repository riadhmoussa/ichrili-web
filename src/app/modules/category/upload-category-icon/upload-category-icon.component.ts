...
@Component({
  selector: 'app-upload-category-icon',
  templateUrl: './upload-category-icon.component.html',
  styleUrls: ['./upload-category-icon.component.css']
})
export class UploadCategoryIconComponent implements OnInit {
  ...
  constructor(@Inject(NgZone) private zone: NgZone) {
    this.options = new NgUploaderOptions({
      url: 'http://localhost:4000/category/upload',
  ...
  ngOnInit() {
   this.options.data = {categoryId: this.category._id};
  }
}
